/*
  ...
  - The values [ACTIVE,INACTIVE,CLOSED] on the enum `JobStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "JobStatus_new" AS ENUM ('APPLIED', 'INTERVIEWING', 'OFFERED', 'REJECTED');
